...
public class GuildPositionVariable extends Variable {

    public GuildPositionVariable(String name) {
        super(name);
    }
    ...
    public String getReplacement(Player player) {
        ...
        return (guild == null ? "" : Integer.toString(guild.getRank().getPosition()));
    }
}
