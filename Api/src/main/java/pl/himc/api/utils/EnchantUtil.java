...
public final class EnchantUtil {
	...
	public EnchantUtil() {
		enchants.put("damage_all", Enchantment.DAMAGE_ALL);
		...
		enchants.put("damage_arthropods", Enchantment.DAMAGE_ARTHROPODS);
		...
		enchants.put("damage_undead", Enchantment.DAMAGE_UNDEAD);
		...
		enchants.put("dig_speed", Enchantment.DIG_SPEED);
		...
		enchants.put("loot_bonus_blocks", Enchantment.LOOT_BONUS_BLOCKS);
		...
		enchants.put("loot_bonus_mobs", Enchantment.LOOT_BONUS_MOBS);
		...
		enchants.put("protection_explosions", Enchantment.PROTECTION_EXPLOSIONS);
		...
		enchants.put("protection_fall", Enchantment.PROTECTION_FALL);
		...
		enchants.put("protection_fire", Enchantment.PROTECTION_FIRE);
		...
		enchants.put("protection_projectile", Enchantment.PROTECTION_PROJECTILE);
		...
		enchants.put("water_worker", Enchantment.WATER_WORKER);
		...
		enchants.put("arrow_fire", Enchantment.ARROW_FIRE);
		...
		enchants.put("arrow_damage", Enchantment.ARROW_DAMAGE);
		...
		enchants.put("arrow_knockback", Enchantment.ARROW_KNOCKBACK);
		...
		enchants.put("arrow_infinite", Enchantment.ARROW_INFINITE);
	...
	public static Enchantment getName(String name) {
		return enchants.get(name.toLowerCase()) != null ? enchants.get(name.toLowerCase()) : Enchantment.getByName(name.toLowerCase());
	}
